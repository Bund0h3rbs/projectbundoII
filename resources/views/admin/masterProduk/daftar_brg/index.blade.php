...
<div class="row text-sm" id="defaultform">
    <div class="col-md-12 order-2 order-md-1">
        <div class="alert bg-warning-disabled ">
            ...
            Pastikan Produk yang ditampilkan di list adalah produk yang akan dipasarkan<br/>
            apabila stok produk kosong, diharapkan status di ganti menjadi <b class="text-danger">DRAF</b> agar konsumen tidak kecewa
        </div>
    </div>
...
@php
$recordsUrl = route('daftar_brg.getlist');
